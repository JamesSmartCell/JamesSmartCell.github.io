...
async function calcContractAddress(web3, fromAccount) {
	...
	var input_arr = [fromAccount, nonce];
	var rlp_encoded = ethers.rlp.encode(input_arr);

	//var contract_address_long = web3.sha3(rlp_encoded);

	var contract_address_long = ethers.keccak('keccak256').update(rlp_encoded).digest('hex');
